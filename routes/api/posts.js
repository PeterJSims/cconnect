...
//Must be logged in to see any posts. Change this later if you want all posts visible to those not logged in
router.get('/', auth, async (req, res) => {
	try {
		//Below is where the order of the posts is determined
...
router.put('/unlike/:id', auth, async (req, res) => {
	try {
		...
		//Get remove index (process is like EXP for Profile route)
